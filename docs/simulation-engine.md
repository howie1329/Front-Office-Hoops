...
> This document describes the existing v1 simulation. The v2 simulation contract, worker boundary, and randomness policy are defined in [FOH v2 Simulation Architecture](./v2/specs/foh-v2-simulation-architecture.md).
